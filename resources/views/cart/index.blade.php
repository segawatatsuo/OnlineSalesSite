    ...
    <main class="container">
        ...
        <div class="cart-actions">
            <button class="continue-shopping"
                onclick="window.location.href='{{ $category ?? null ? asset('products/' . $category) : url('/') }}'">
                買い物を続ける
            </button>
            <button class="checkout-btn" onclick="window.location.href='{{ route('orders.create') }}'">購入手続きに進む</button>
        </div>
    </main>
@endsection
