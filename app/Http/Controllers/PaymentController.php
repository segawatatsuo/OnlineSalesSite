...
use Illuminate\Support\Facades\Mail; // Mailファサードをuseする
use App\Models\Customer; // Customerモデルをuseする
use App\Models\Delivery; // Deliveryモデルをuseする
use App\Models\OrderItem; // OrderItemモデルをuseする
use App\Mail\OrderConfirmed; // OrderConfirmedメールをuseする
use App\Mail\OrderNotification; // OrderNotificationメールをuseする
...
class PaymentController extends Controller
{
    ...
    // generateOrderNumberメソッドを追加 (OrderControllerから移動または再定義)
    private function generateOrderNumber()
    {
        // 実際にはもっと複雑なロジックで重複しない番号を生成すべきです
        return 'ORDER-' . time() . '-' . uniqid();
    }
