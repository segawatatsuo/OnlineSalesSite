...
class OrderCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'order_phone'   => ['required', 'string', 'max:20'],
            ...
            'delivery_add03' => 'required_if:same_as_orderer,0|nullable|string|max:255',
